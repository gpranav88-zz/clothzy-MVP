...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.map_url'
        db.alter_column(u'shop_store', 'map_url', self.gf('django.db.models.fields.URLField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Store.map_url'
        db.alter_column(u'shop_store', 'map_url', self.gf('django.db.models.fields.URLField')(max_length=200))
