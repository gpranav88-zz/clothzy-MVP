...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.latest_news'
        db.alter_column(u'shop_store', 'latest_news', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Store.designer_bio'
        db.alter_column(u'shop_store', 'designer_bio', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Store.description'
        db.alter_column(u'shop_store', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Store.address'
        db.alter_column(u'shop_store', 'address', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Store.latest_news'
        db.alter_column(u'shop_store', 'latest_news', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Store.designer_bio'
        db.alter_column(u'shop_store', 'designer_bio', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Store.description'
        db.alter_column(u'shop_store', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Store.address'
        db.alter_column(u'shop_store', 'address', self.gf('django.db.models.fields.TextField')())
