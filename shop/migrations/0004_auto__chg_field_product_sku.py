...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shop_product', 'sku', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Product.sku'
        db.alter_column(u'shop_product', 'sku', self.gf('django.db.models.fields.CharField')(max_length=20))
