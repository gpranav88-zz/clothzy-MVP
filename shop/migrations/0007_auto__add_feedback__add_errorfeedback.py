...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('response', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'shop', ['Feedback'])

        # Adding model 'ErrorFeedback'
        db.create_table(u'shop_errorfeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('response', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'shop', ['ErrorFeedback'])


    def backwards(self, orm):
        # Deleting model 'Feedback'
        db.delete_table(u'shop_feedback')

        # Deleting model 'ErrorFeedback'
        db.delete_table(u'shop_errorfeedback')


    models = {
        u'shop.errorfeedback': {
            'Meta': {'object_name': 'ErrorFeedback'},
