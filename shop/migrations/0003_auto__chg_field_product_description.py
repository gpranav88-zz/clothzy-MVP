...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shop_product', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Product.description'
        db.alter_column(u'shop_product', 'description', self.gf('django.db.models.fields.TextField')())
