...
urlpatterns = patterns('',
    ...
    url(r'^api/errorFeedback', views.errorFeedback),
    url(r'^api/search/product.*$', views.ProductSearchView.as_view()),
    url(r'^api/search/store.*$', views.StoreSearchView.as_view()),
    ...
    #index
    url('^store|product|search|review|contact|privacy-policy|designers-brands|about|product-test|user\/.*', 'clothzy.views.home', name="home")
)
