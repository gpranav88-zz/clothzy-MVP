...
var fm = (function () {
	...
	function appendFeedbackToBody() {
		...
		if (fm_options.show_radio_button_list === true) {
			radio1_button_list_html = "<li><div id=\"radio_button_list_title_wrapper\"><div id=\"radio_button_list_title\">" + fm_options.radio1_button_list_title + radio_button_list_asterisk + "</div></div><div id=\"radio_button_list_wrapper\">";
			radio1_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio1_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio1\" id=\"feedback_radio_1\" " + radio_button_list_required + "\/>";
			radio1_button_list_html += "        <label for=\"feedback_radio_1\">" + fm_options.radio_button_list_labels[0] + "<\/label>";
			radio1_button_list_html += "    <\/div>";
			radio1_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio1_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio1\" id=\"feedback_radio_2\"\/>";
			radio1_button_list_html += "        <label for=\"feedback_radio_2\">" + fm_options.radio_button_list_labels[1] + "<\/label>";
			radio1_button_list_html += "    <\/div>";
			radio1_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio1_button_list_html += "        <input value=\"3\" type=\"radio\" name=\"feedback_radio1\" id=\"feedback_radio_3\"\/>";
			radio1_button_list_html += "        <label for=\"feedback_radio_3\">" + fm_options.radio_button_list_labels[2] + "<\/label>";
			radio1_button_list_html += "    <\/div>";
			radio1_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio1_button_list_html += "        <input value=\"4\" type=\"radio\" name=\"feedback_radio1\" id=\"feedback_radio_4\"\/>";
			radio1_button_list_html += "        <label for=\"feedback_radio_4\">" + fm_options.radio_button_list_labels[3] + "<\/label>";
			radio1_button_list_html += "    <\/div>";
			radio1_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio1_button_list_html += "        <input value=\"5\" type=\"radio\" name=\"feedback_radio1\" id=\"feedback_radio_5\"\/>";
			radio1_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio_button_list_labels[4] + "<\/label>";
			radio1_button_list_html += "    <\/div>";
			radio1_button_list_html += "<\/div></li>";

			radio2_button_list_html = "<li><div id=\"radio_button_list_title_wrapper\"><div id=\"radio_button_list_title\">" + fm_options.radio2_button_list_title + radio_button_list_asterisk + "</div></div><div id=\"radio_button_list_wrapper\">";
			radio2_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio2_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio2\" id=\"feedback_radio_1\" " + radio_button_list_required + "\/>";
			radio2_button_list_html += "        <label for=\"feedback_radio_1\">" + fm_options.radio_button_list_labels[0] + "<\/label>";
			radio2_button_list_html += "    <\/div>";
			radio2_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio2_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio2\" id=\"feedback_radio_2\"\/>";
			radio2_button_list_html += "        <label for=\"feedback_radio_2\">" + fm_options.radio_button_list_labels[1] + "<\/label>";
			radio2_button_list_html += "    <\/div>";
			radio2_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio2_button_list_html += "        <input value=\"3\" type=\"radio\" name=\"feedback_radio2\" id=\"feedback_radio_3\"\/>";
			radio2_button_list_html += "        <label for=\"feedback_radio_3\">" + fm_options.radio_button_list_labels[2] + "<\/label>";
			radio2_button_list_html += "    <\/div>";
			radio2_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio2_button_list_html += "        <input value=\"4\" type=\"radio\" name=\"feedback_radio2\" id=\"feedback_radio_4\"\/>";
			radio2_button_list_html += "        <label for=\"feedback_radio_4\">" + fm_options.radio_button_list_labels[3] + "<\/label>";
			radio2_button_list_html += "    <\/div>";
			radio2_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio2_button_list_html += "        <input value=\"5\" type=\"radio\" name=\"feedback_radio2\" id=\"feedback_radio_5\"\/>";
			radio2_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio_button_list_labels[4] + "<\/label>";
			radio2_button_list_html += "    <\/div>";
			radio2_button_list_html += "<\/div></li>";

			radio3_button_list_html = "<li><div id=\"radio_button_list_title_wrapper\"><div id=\"radio_button_list_title\">" + fm_options.radio3_button_list_title + radio_button_list_asterisk + "</div></div><div id=\"radio_button_list_wrapper\">";
			radio3_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio3_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio3\" id=\"feedback_radio_1\" " + radio_button_list_required + "\/>";
			radio3_button_list_html += "        <label for=\"feedback_radio_1\">" + fm_options.radio_button_list_labels[0] + "<\/label>";
			radio3_button_list_html += "    <\/div>";
			radio3_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio3_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio3\" id=\"feedback_radio_2\"\/>";
			radio3_button_list_html += "        <label for=\"feedback_radio_2\">" + fm_options.radio_button_list_labels[1] + "<\/label>";
			radio3_button_list_html += "    <\/div>";
			radio3_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio3_button_list_html += "        <input value=\"3\" type=\"radio\" name=\"feedback_radio3\" id=\"feedback_radio_3\"\/>";
			radio3_button_list_html += "        <label for=\"feedback_radio_3\">" + fm_options.radio_button_list_labels[2] + "<\/label>";
			radio3_button_list_html += "    <\/div>";
			radio3_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio3_button_list_html += "        <input value=\"4\" type=\"radio\" name=\"feedback_radio3\" id=\"feedback_radio_4\"\/>";
			radio3_button_list_html += "        <label for=\"feedback_radio_4\">" + fm_options.radio_button_list_labels[3] + "<\/label>";
			radio3_button_list_html += "    <\/div>";
			radio3_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio3_button_list_html += "        <input value=\"5\" type=\"radio\" name=\"feedback_radio3\" id=\"feedback_radio_5\"\/>";
			radio3_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio_button_list_labels[4] + "<\/label>";
			radio3_button_list_html += "    <\/div>";
			radio3_button_list_html += "<\/div></li>";

			radio4_button_list_html = "<li><div id=\"radio_button_list_title_wrapper\"><div id=\"radio_button_list_title\">" + fm_options.radio4_button_list_title + radio_button_list_asterisk + "</div></div><div id=\"radio_button_list_wrapper\">";
			radio4_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio4_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio4\" id=\"feedback_radio_1\" " + radio_button_list_required + "\/>";
			radio4_button_list_html += "        <label for=\"feedback_radio_1\">" + fm_options.radio_button_list_labels[0] + "<\/label>";
			radio4_button_list_html += "    <\/div>";
			radio4_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio4_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio4\" id=\"feedback_radio_2\"\/>";
			radio4_button_list_html += "        <label for=\"feedback_radio_2\">" + fm_options.radio_button_list_labels[1] + "<\/label>";
			radio4_button_list_html += "    <\/div>";
			radio4_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio4_button_list_html += "        <input value=\"3\" type=\"radio\" name=\"feedback_radio4\" id=\"feedback_radio_3\"\/>";
			radio4_button_list_html += "        <label for=\"feedback_radio_3\">" + fm_options.radio_button_list_labels[2] + "<\/label>";
			radio4_button_list_html += "    <\/div>";
			radio4_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio4_button_list_html += "        <input value=\"4\" type=\"radio\" name=\"feedback_radio4\" id=\"feedback_radio_4\"\/>";
			radio4_button_list_html += "        <label for=\"feedback_radio_4\">" + fm_options.radio_button_list_labels[3] + "<\/label>";
			radio4_button_list_html += "    <\/div>";
			radio4_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio4_button_list_html += "        <input value=\"5\" type=\"radio\" name=\"feedback_radio4\" id=\"feedback_radio_5\"\/>";
			radio4_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio_button_list_labels[4] + "<\/label>";
			radio4_button_list_html += "    <\/div>";
			radio4_button_list_html += "<\/div></li>";

			radio5_button_list_html = "<li><label>Would you use Clothzy again?</label> <div id=\"radio_button_list_wrapper\">";
			radio5_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio5_button_list_html += "        <input value=\"Yes\" type=\"radio\" name=\"feedback_radio5\" id=\"feedback_radio_1\" " + radio_button_list_required + "\/>";
			radio5_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio5_button_list_labels[0] + "<\/label>";
			radio5_button_list_html += "    <\/div>";

			radio5_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio5_button_list_html += "        <input value=\"No\" type=\"radio\" name=\"feedback_radio5\" id=\"feedback_radio_5\"\/>";
			radio5_button_list_html += "        <label for=\"feedback_radio_5\">" + fm_options.radio5_button_list_labels[1] + "<\/label>";
			radio5_button_list_html += "    <\/div>";
			radio5_button_list_html += "<\/div></li>";

			radio1_button_list_class = " radio_button_list_present";
		}
		...
		$('body').append('<div id="feedback_content" class="feedback_content_closed ' + fm_options.position + email_feedback_content_class + radio1_button_list_class + jQueryUIClasses2 + fm_class + jquery_class + bootstrap_class + bootstrap_hero_unit + '">'
